...
export default new Vuex.Store({
    ...
    mutations: {
        ...
        //     }
        //     state.products[i].sales.unshift(x)
        //     state.products[i].sales.lastSize = sale.last_size
        //     state.products[i].sales.lastPrice = sale.price
        //     state.products[i].sales.sequence = sale.sequence
        ...
        //         if (state.products[i].sales[i].price > state.products[i].sales[i+1].price) {
        //             state.products[i].sales[i].change = '+'
        //             state.products[i].sales[i].class = 'sales-span has-text-centered has-text-success'
        //         } else if (state.products[i].sales[i].price < state.products[i].sales[i + 1].price) {
        //             state.products[i].sales[i].change = '-'
        //             state.products[i].sales[i].class = 'sales-span has-text-centered has-text-danger'
        //         } else {
        //             state.products[i].sales[i].change = '='
        //             state.products[i].sales[i].class = state.products[i].sales[i+1].class
        //         }
        //     }
        // },
        ...
        //         class: ''
        //     }
        //     // add new trade to array then sort
        //     state.products[i].sales = _.chain(state.products[i].sales)
        //                                 .concat(x)
        //                                 .orderBy((o) => { o.sequence }, ['desc'])
        //                                 .value()
